...
MSG_BUTTON_ABOUT = "ℹ️ About Knox"
...
MSG_HELP = (
    ...
    "> • Knox needs administrator rights in the group to function.\n"
    ...
    "> • Auto-posting links if Knox has admin privileges with delete rights.\n\n"
...
MSG_ABOUT = (
    "🌟 **About Knox** ℹ️\n\n"
    "Knox is your go-to for **instant download & streaming!** ⚡\n\n"
    "**🚀 Key Features:**\n"
...
MSG_LINKS = (
    ...
    "🚀 **Download Link:**\n`{download_link}`\n\n"
    "🖥️ **Stream Link:**\n`{stream_link}`\n\n"
    "⌛️ **Note: Links remain active while Knox is running and the file is accessible.**"
)
