...
from Knox.server.exceptions import InvalidHash
from Knox.utils.file_properties import get_fname, get_uniqid
from Knox.utils.logger import logger
from Knox.vars import Var

template_env = Environment(
    loader=FileSystemLoader('Knox/template'),
    enable_async=True,
    cache_size=200,
    auto_reload=False,
    optimized=True
