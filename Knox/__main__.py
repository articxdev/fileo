...
from Knox import __version__
from Knox.bot import StreamBot
from Knox.bot.clients import cleanup_clients, initialize_clients
from Knox.server import web_server
from Knox.utils.commands import set_commands
from Knox.utils.database import db
from Knox.utils.keepalive import ping_server
from Knox.utils.logger import logger
from Knox.utils.messages import MSG_ADMIN_RESTART_DONE
from Knox.utils.rate_limiter import rate_limiter, request_executor
from Knox.utils.tokens import cleanup_expired_tokens
from Knox.vars import Var


PLUGIN_PATH = "Knox/bot/plugins/*.py"
VERSION = __version__
...
async def import_plugins():
    ...
    for file_path in plugins:
        try:
            ...
            import_path = f"Knox.bot.plugins.{plugin_name}"
