...
from Knox import StartTime, __version__
from Knox.bot import StreamBot, multi_clients, work_loads
from Knox.utils.bot_utils import reply
from Knox.utils.broadcast import broadcast_message
from Knox.utils.database import db
from Knox.utils.human_readable import humanbytes
from Knox.utils.logger import LOG_FILE, logger
...
from Knox.utils.tokens import authorize, deauthorize, list_allowed
from Knox.utils.speedtest import run_speedtest
...
async def restart_bot(client: Client, message: Message):
    ...
    os.execv("/bin/bash", ["bash", "knox.sh"])
